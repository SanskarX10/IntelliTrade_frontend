...
function NoOptionsMessage(props) {
    return ( <
        ...
        className = { props.selectProps.classes.noOptionsMessage } {...props.innerProps } > { props.children } <
        /Typography>
    );
}
...
function Placeholder(props) {
    return ( <
        Typography color = "textSecondary"
        className = { props.selectProps.classes.placeholder } {...props.innerProps } > { props.children } <
        /Typography>
    );
}
...
function MultiValue(props) {
    ...
    class SearchBar extends React.Component {
        ...
        handleSearchChange = name => value => {
            console.log("skjfnkj", name, "slnjs", value)
            this.setState({
                [name]: value
            });
        };
        ...
        render() {
            ...
            return ( <
                ...
                value = { multi }
                onChange = {
                    (e) => this.handleSearchChange(e.value)
                }
